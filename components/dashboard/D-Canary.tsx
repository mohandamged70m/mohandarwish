    ...
    return (
        <div className="w-full h-full flex flex-col gap-6" style={{ opacity: 1 }}>
            ...
            {activeSection === 'hours' ? hoursEditor : activeSection === 'bookings' ? (
                ...
                <div className="canary-section grid grid-cols-1 lg:grid-cols-[minmax(0,360px)_minmax(0,1fr)] gap-5 lg:gap-6" style={{ alignItems: windowWidth >= 1024 ? 'stretch' : 'start' }}>
                    {/* Left: Calendar Component */}
                    <div className="canary-panel w-full h-fit flex flex-col gap-3 sm:gap-4 p-4 sm:p-5 rounded-[20px] border shadow-sm relative overflow-visible"
                        style={{
                        ...
                        <div className="flex items-center justify-between relative z-10 mb-2">
                            <div className="flex flex-col">
                                <div className="flex items-center gap-4">
                                    <h3 className="text-lg sm:text-xl font-bold m-0" style={{ color: isDark ? '#fff' : '#000' }}>
                                    ...
                                    {calendarDays.map((date, idx) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`relative rounded-lg md:rounded-xl transition-all duration-200 cursor-pointer flex flex-col items-center justify-center gap-0.5
                ...
                /* Mails Section */
                <div className="canary-section grid grid-cols-1 lg:grid-cols-[minmax(0,340px)_minmax(0,1fr)] gap-6 md:gap-8 h-full min-h-[600px] max-h-[900px]">
                    {/* Left: Mails List */}
