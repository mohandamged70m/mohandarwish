              ...
              <div className="relative grid gap-8 p-6 sm:gap-10 sm:p-7 md:grid-cols-[1.25fr_0.9fr] md:items-stretch md:gap-6 md:p-6">
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-wrap items-center gap-3 pt-1">
                    ...
                    >
                      {copied ? <Check className="h-4 w-4 shrink-0 text-accent-text" aria-hidden /> : <Copy className="h-4 w-4 shrink-0" aria-hidden />}
                  ...
                  <div className="flex flex-wrap items-center gap-3 pt-2 font-heading text-sm">
                    <Link
                      href="/projects"
                      className="focus-ring group inline-flex items-center gap-1.5 text-text-secondary underline decoration-border underline-offset-4 transition-colors hover:text-accent-text hover:decoration-accent"
                    >
                      See projects
